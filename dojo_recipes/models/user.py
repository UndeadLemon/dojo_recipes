from dojo_recipes.config.mysqlconnection import connectToMySQL
...
class User:
    ...
    def save(cls, data):
        ...
        query = "INSERT INTO users (first_name, last_name, email, birthday, password, created_at, updated_at) VALUES ( %(first_name)ws, %(last_name)s, %(email)s, %(birthday)s, %(password)s, NOW(), NOW() );"
